...
1. If $X \sim N(100,16)$, find $P(90 \le X \le 110)$ using Z-scores or tables.
...
1. A sample of size $n = 25$ from a normal population has $\bar{X} = 50$ and $s = 4$. Construct a 95% confidence interval for $\mu$.
